  ...
  <v-navigation-drawer app color="white" right width="290">
      ...
      <v-list subheader two-line class="mt-n4">
          <v-list-item v-for="file in files" :key="file.title">
            ...
            <v-list-item-action>
                <v-btn icon>
                    <v-icon color="grey lighten-1" small>fas fa-ellipsis-h</v-icon>
                </v-btn>
            </v-list-item-action>
            </v-list-item>
      </v-list>
      ...
      <v-card class="mx-2 rounded-l-xl pb-1" flat color="#EEEEEE">
          <v-row>
              <v-col cols="12" sm="5">
              ...
              <v-col cols="12" sm="4">
                  <v-progress-circular :size="50" :width="3" :value="75" color="teal" class="ml-n5 mt-n1">
                      75
                  </v-progress-circular>
              </v-col>
              <v-col cols="12" sm="3" class="mt-2">
                  <span class="ml-n8">percent</span>
              </v-col>
          </v-row>
      </v-card>
              ...
              <v-col cols="12" sm="5">
                  <v-list-item two-line class="mt-n4" >
                      <v-list-item-content>
                          ...
                          <v-list-item-subtitle class="">goals</v-list-item-subtitle>
                      </v-list-item-content>
                  </v-list-item>
              </v-col>
              <v-col cols="12" sm="4">
                  <v-progress-circular :size="50" :width="3" :value="25" color="teal" class="ml-n5 mt-n1">
                      25
                  </v-progress-circular>
              </v-col>
              <v-col cols="12" sm="3" class="mt-2">
              ...
              <v-col cols="12" sm="5">
                  <v-list-item two-line class="mt-n4" >
                      <v-list-item-content>
                          ...
                          <v-list-item-subtitle class="">used</v-list-item-subtitle>
                      </v-list-item-content>
                  </v-list-item>
              </v-col>
              <v-col cols="12" sm="4">
                  <v-progress-circular :size="50" :width="3" :value="42" color="teal" class="ml-n5 mt-n1">
                      42
                  </v-progress-circular>
              </v-col>
              <v-col cols="12" sm="3" class="mt-2">
